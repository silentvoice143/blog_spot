...
function GoogleLogin({ setAuthentication }) {
  ...
  return (
    <button
      onClick={googleLogin}
      className="flex items-center justify-center px-6 py-3 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors duration-200 shadow-sm"
    >
